...
#[doc = "Field `PR` reader - desc PR"]
pub type PR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PR` writer - desc PR"]
pub type PR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PR_SPEC, u32, u32, 19, O>;
impl R {
    #[doc = "Bits 0:18 - desc PR"]
    #[inline(always)]
    pub fn pr(&self) -> PR_R {
        PR_R::new((self.bits & 0x0007_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:18 - desc PR"]
