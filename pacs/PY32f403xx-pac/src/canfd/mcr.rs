...
#[doc = "Field `FD_ISO` reader - desc FD_ISO"]
pub type FD_ISO_R = crate::BitReader<bool>;
#[doc = "Field `FD_ISO` writer - desc FD_ISO"]
pub type FD_ISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCR_SPEC, bool, O>;
