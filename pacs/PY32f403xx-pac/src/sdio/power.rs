...
#[doc = "Field `PWRCTRL` reader - desc PWRCTRL"]
pub type PWRCTRL_R = crate::BitReader<bool>;
#[doc = "Field `PWRCTRL` writer - desc PWRCTRL"]
pub type PWRCTRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POWER_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - desc PWRCTRL"]
    #[inline(always)]
    pub fn pwrctrl(&self) -> PWRCTRL_R {
        PWRCTRL_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - desc PWRCTRL"]
