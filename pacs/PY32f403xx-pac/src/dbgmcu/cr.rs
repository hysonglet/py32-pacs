...
#[doc = "Field `DBG_SLLEP` reader - desc DBG_SLLEP"]
pub type DBG_SLLEP_R = crate::BitReader<bool>;
#[doc = "Field `DBG_SLLEP` writer - desc DBG_SLLEP"]
pub type DBG_SLLEP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 0 - desc DBG_SLLEP"]
    #[inline(always)]
    pub fn dbg_sllep(&self) -> DBG_SLLEP_R {
        DBG_SLLEP_R::new((self.bits & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - desc DBG_SLLEP"]
    #[inline(always)]
    pub fn dbg_sllep(&mut self) -> DBG_SLLEP_W<0> {
        DBG_SLLEP_W::new(self)
    }
    #[doc = "Bit 1 - desc DBG_STOP"]
    #[inline(always)]
