...
#[doc = "Field `JDR1` reader - desc JDR1"]
pub type JDR1_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - desc JDR1"]
    #[inline(always)]
    pub fn jdr1(&self) -> JDR1_R {
        JDR1_R::new((self.bits & 0xffff) as u16)
    }
}
