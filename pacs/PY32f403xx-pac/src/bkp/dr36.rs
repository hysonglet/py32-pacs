...
pub struct R(crate::R<DR36_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DR36_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DR36_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DR36_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DR36` writer"]
pub struct W(crate::W<DR36_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DR36_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DR36_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DR36_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type D_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DR36_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "desc DR36\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dr36](index.html) module"]
