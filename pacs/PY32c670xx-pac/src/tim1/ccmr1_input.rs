...
pub type ICPSC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ICPSC` writer - Input capture 1 prescaler"]
pub type ICPSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCMR1_INPUT_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[doc = "Bits 2:3 - Input capture 1 prescaler"]
    #[inline(always)]
    pub fn icpsc(&mut self) -> ICPSC_W<2> {
        ICPSC_W::new(self)
    }
    #[doc = "Bits 4:7 - Input capture 1 filter"]
    #[inline(always)]
