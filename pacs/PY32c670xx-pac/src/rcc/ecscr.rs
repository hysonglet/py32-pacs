...
#[doc = "Field `HSE_DRIVER` reader - HSE clock driver selection"]
pub type HSE_DRIVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HSE_DRIVER` writer - HSE clock driver selection"]
pub type HSE_DRIVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ECSCR_SPEC, u8, u8, 2, O>;
#[doc = "Field `HSE_STARTUP` reader - HSE clock start up"]
pub type HSE_STARTUP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HSE_STARTUP` writer - HSE clock start up"]
...
#[doc = "Field `LSE_STARTUP` reader - LSE clock start up"]
pub type LSE_STARTUP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LSE_STARTUP` writer - LSE clock start up"]
pub type LSE_STARTUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ECSCR_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:1 - HSE clock driver selection"]
    #[inline(always)]
    pub fn hse_driver(&self) -> HSE_DRIVER_R {
        HSE_DRIVER_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 3:4 - HSE clock start up"]
    #[inline(always)]
    ...
    #[doc = "Bits 20:21 - LSE clock start up"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:1 - HSE clock driver selection"]
    #[inline(always)]
    pub fn hse_driver(&mut self) -> HSE_DRIVER_W<0> {
        HSE_DRIVER_W::new(self)
    }
    #[doc = "Bits 3:4 - HSE clock start up"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ECSCR to value 0x0003_0003"]
