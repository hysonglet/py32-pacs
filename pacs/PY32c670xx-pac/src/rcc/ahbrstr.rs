...
#[doc = "Field `DIVRST` reader - DIV reset"]
pub type DIVRST_R = crate::BitReader<bool>;
#[doc = "Field `DIVRST` writer - DIV reset"]
pub type DIVRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBRSTR_SPEC, bool, O>;
