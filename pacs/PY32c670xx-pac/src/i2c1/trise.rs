...
pub type TRISE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRISE_SPEC, u8, u8, 7, O>;
#[doc = "Field `THOLDDATA` reader - desc THOLDDATA"]
pub type THOLDDATA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `THOLDDATA` writer - desc THOLDDATA"]
pub type THOLDDATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRISE_SPEC, u8, u8, 5, O>;
#[doc = "Field `THOLDDATA_SEL` reader - desc THOLDDATA_SEL"]
pub type THOLDDATA_SEL_R = crate::BitReader<bool>;
#[doc = "Field `THOLDDATA_SEL` writer - desc THOLDDATA_SEL"]
pub type THOLDDATA_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRISE_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:6 - Maximum rise time in Fast/Standard mode (Master mode)"]
    #[inline(always)]
    pub fn trise(&self) -> TRISE_R {
        TRISE_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 7:11 - desc THOLDDATA"]
    #[inline(always)]
    pub fn tholddata(&self) -> THOLDDATA_R {
        THOLDDATA_R::new(((self.bits >> 7) & 0x1f) as u8)
    }
    #[doc = "Bit 12 - desc THOLDDATA_SEL"]
    #[inline(always)]
    pub fn tholddata_sel(&self) -> THOLDDATA_SEL_R {
        THOLDDATA_SEL_R::new(((self.bits >> 12) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6 - Maximum rise time in Fast/Standard mode (Master mode)"]
    ...
    #[doc = "Bits 7:11 - desc THOLDDATA"]
    #[inline(always)]
    pub fn tholddata(&mut self) -> THOLDDATA_W<7> {
        THOLDDATA_W::new(self)
    }
    #[doc = "Bit 12 - desc THOLDDATA_SEL"]
    #[inline(always)]
    pub fn tholddata_sel(&mut self) -> THOLDDATA_SEL_W<12> {
        THOLDDATA_SEL_W::new(self)
    }
