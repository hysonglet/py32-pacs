...
#[doc = "Field `FP` reader - I2C master FP mode selection"]
pub type FP_R = crate::BitReader<bool>;
#[doc = "Field `FP` writer - I2C master FP mode selection"]
pub type FP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, bool, O>;
...
#[doc = "Field `FS` reader - I2C master mode selection"]
pub type FS_R = crate::BitReader<bool>;
#[doc = "Field `FS` writer - I2C master mode selection"]
pub type FS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 13 - I2C master FP mode selection"]
    #[inline(always)]
    pub fn fp(&self) -> FP_R {
