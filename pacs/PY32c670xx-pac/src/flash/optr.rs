...
#[doc = "Field `IDWG_STOP` reader - Stop mode IWDG counter"]
pub type IDWG_STOP_R = crate::BitReader<bool>;
#[doc = "Field `IDWG_STOP` writer - Stop mode IWDG counter"]
pub type IDWG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPTR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 11 - Stop mode IWDG counter"]
    #[inline(always)]
    pub fn idwg_stop(&self) -> IDWG_STOP_R {
        IDWG_STOP_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    #[doc = "Bit 16 - BOR reset Level"]
    #[inline(always)]
    pub fn boren(&self) -> BOREN_R {
        BOREN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bits 17:19 - These bits contain the VDD supply level threshold that activates the reset"]
    #[inline(always)]
    pub fn borf_lev(&self) -> BORF_LEV_R {
        BORF_LEV_R::new(((self.bits >> 17) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Read Protection"]
    ...
    #[doc = "Bit 11 - Stop mode IWDG counter"]
    #[inline(always)]
    pub fn idwg_stop(&mut self) -> IDWG_STOP_W<11> {
        IDWG_STOP_W::new(self)
    }
    #[doc = "Bit 12 - Independent watchdog selection"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Window watchdog selection"]
    #[inline(always)]
    pub fn wwdg_sw(&mut self) -> WWDG_SW_W<13> {
        WWDG_SW_W::new(self)
    }
    #[doc = "Bit 14 - NRST_MODE"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - BOR reset Level"]
    #[inline(always)]
    pub fn boren(&mut self) -> BOREN_W<16> {
        BOREN_W::new(self)
    }
    #[doc = "Bits 17:19 - These bits contain the VDD supply level threshold that activates the reset"]
    #[inline(always)]
    pub fn borf_lev(&mut self) -> BORF_LEV_W<17> {
        BORF_LEV_W::new(self)
    }
