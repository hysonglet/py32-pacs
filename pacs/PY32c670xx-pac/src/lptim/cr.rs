...
#[doc = "Field `CNTSTRT` reader - LPTIM start in continue mode"]
pub type CNTSTRT_R = crate::BitReader<bool>;
#[doc = "Field `CNTSTRT` writer - LPTIM start in continue mode"]
pub type CNTSTRT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
#[doc = "Field `COUNTRST` reader - LPTIM counter reset"]
pub type COUNTRST_R = crate::BitReader<bool>;
#[doc = "Field `COUNTRST` writer - LPTIM counter reset"]
...
impl R {
    ...
    #[doc = "Bit 2 - LPTIM start in continue mode"]
    #[inline(always)]
    pub fn cntstrt(&self) -> CNTSTRT_R {
        CNTSTRT_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - LPTIM counter reset"]
    #[inline(always)]
