...
pub enum Interrupt {
    ...
    USART2 = 28,
    #[doc = "29 - USART3 global Interrupt"]
    USART3 = 29,
    #[doc = "30 - SQRT global Interrupt"]
    SQRT = 30,
    #[doc = "31 - CORDIC global Interrupt"]
    CORDIC = 31,
}
...
#[doc = "Divider"]
pub mod div;
#[doc = "Digital Co-process Operation"]
pub struct CORDIC {
    _marker: PhantomData<*const ()>,
}
...
impl CORDIC {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const cordic::RegisterBlock = 0x4002_3400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
