...
pub type CHSEL11_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHSELR_SPEC, bool, O>;
...
pub type CHSEL12_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHSELR_SPEC, bool, O>;
#[doc = "Field `CHSEL13` reader - Channel-13 selection"]
pub type CHSEL13_R = crate::BitReader<bool>;
#[doc = "Field `CHSEL13` writer - Channel-13 selection"]
pub type CHSEL13_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHSELR_SPEC, bool, O>;
#[doc = "Field `CHSEL14` reader - Channel-14 selection"]
pub type CHSEL14_R = crate::BitReader<bool>;
#[doc = "Field `CHSEL14` writer - Channel-14 selection"]
pub type CHSEL14_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHSELR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 13 - Channel-13 selection"]
    #[inline(always)]
    pub fn chsel13(&self) -> CHSEL13_R {
        CHSEL13_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Channel-14 selection"]
    #[inline(always)]
