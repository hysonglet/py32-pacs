...
#[doc = "Field `OFFSUC` reader - Offset calibration status flag"]
pub type OFFSUC_R = crate::BitReader<bool>;
#[doc = "Field `OFFSUC` writer - Offset calibration status flag"]
pub type OFFSUC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCSR_SPEC, bool, O>;
#[doc = "Field `CAPSUC` reader - Cap calibration status flag"]
pub type CAPSUC_R = crate::BitReader<bool>;
#[doc = "Field `CAPSUC` writer - Cap calibration status flag"]
pub type CAPSUC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCSR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 29 - Offset calibration status flag"]
    #[inline(always)]
    pub fn offsuc(&self) -> OFFSUC_R {
        OFFSUC_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Cap calibration status flag"]
    #[inline(always)]
    pub fn capsuc(&self) -> CAPSUC_R {
        CAPSUC_R::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 30 - Cap calibration status flag"]
    #[inline(always)]
    pub fn capsuc(&mut self) -> CAPSUC_W<30> {
        CAPSUC_W::new(self)
    }
