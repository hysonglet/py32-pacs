...
pub struct RegisterBlock {
    ...
    pub cfgr2: CFGR2,
    #[doc = "0x14 - ADC sampling time register 0"]
    pub smpr0: SMPR0,
    #[doc = "0x18 - ADC sampling time register 1"]
    pub smpr1: SMPR1,
    _reserved7: [u8; 0x04],
    #[doc = "0x20 - ADC analog watchdog 1 threshold register"]
    pub tr: TR,
    #[doc = "0x24 - ADC group regular sequencer register"]
    pub chselr: CHSELR,
    #[doc = "0x28 - ADC sequence select register 0"]
    pub seqr0: SEQR0,
    #[doc = "0x2c - ADC sequence select register 1"]
    pub seqr1: SEQR1,
    _reserved11: [u8; 0x10],
...
pub mod cfgr2;
#[doc = "SMPR0 (rw) register accessor: an alias for `Reg<SMPR0_SPEC>`"]
...
pub mod chselr;
#[doc = "SEQR0 (rw) register accessor: an alias for `Reg<SEQR0_SPEC>`"]
