...
pub type SDK_STRT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SDKR_SPEC, u8, u8, 5, O>;
...
pub type SDK_END_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SDKR_SPEC, u8, u8, 5, O>;
impl R {
