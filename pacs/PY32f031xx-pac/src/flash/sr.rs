...
#[doc = "Field `USRLOCK` reader - User data flash lock"]
pub type USRLOCK_R = crate::BitReader<bool>;
#[doc = "Field `USRLOCK` writer - User data flash lock"]
pub type USRLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 13 - User data flash lock"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 13 - User data flash lock"]
    #[inline(always)]
    pub fn usrlock(&mut self) -> USRLOCK_W<13> {
        USRLOCK_W::new(self)
    }
    #[doc = "Bit 15 - Option and Engineering bits loading validity error"]
    #[inline(always)]
