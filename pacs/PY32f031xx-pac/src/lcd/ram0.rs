...
pub type D_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RAM0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - des D"]
    #[inline(always)]
    pub fn d(&self) -> D_R {
...
#[doc = "`read()` method returns [ram0::R](R) reader structure"]
impl crate::Readable for RAM0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ram0::W](W) writer structure"]
impl crate::Writable for RAM0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RAM0 to value 0"]
