...
pub type D_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RAM2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - des D"]
    #[inline(always)]
    pub fn d(&self) -> D_R {
...
#[doc = "`read()` method returns [ram2::R](R) reader structure"]
impl crate::Readable for RAM2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ram2::W](W) writer structure"]
impl crate::Writable for RAM2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RAM2 to value 0"]
