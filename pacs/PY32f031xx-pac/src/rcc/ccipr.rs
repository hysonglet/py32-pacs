...
#[doc = "Field `TIMCLKCTRL` reader - TIMER PCLK frequency control"]
pub type TIMCLKCTRL_R = crate::BitReader<bool>;
#[doc = "Field `TIMCLKCTRL` writer - TIMER PCLK frequency control"]
pub type TIMCLKCTRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCIPR_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 0 - TIMER PCLK frequency control"]
    #[inline(always)]
    pub fn timclkctrl(&self) -> TIMCLKCTRL_R {
        TIMCLKCTRL_R::new((self.bits & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - TIMER PCLK frequency control"]
    #[inline(always)]
    pub fn timclkctrl(&mut self) -> TIMCLKCTRL_W<0> {
        TIMCLKCTRL_W::new(self)
    }
    #[doc = "Bit 7 - PVD detect clock source selection"]
    #[inline(always)]
