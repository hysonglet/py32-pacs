...
#[doc = "Field `HDIVEN` reader - DIV clock enable"]
pub type HDIVEN_R = crate::BitReader<bool>;
#[doc = "Field `HDIVEN` writer - DIV clock enable"]
pub type HDIVEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBENR_SPEC, bool, O>;
...
pub type CORDICEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBENR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 24 - DIV clock enable"]
    #[inline(always)]
    pub fn hdiven(&self) -> HDIVEN_R {
        HDIVEN_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - CORDIC clock enable"]
    #[inline(always)]
    pub fn cordicen(&self) -> CORDICEN_R {
        CORDICEN_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA clock enable"]
    ...
    #[doc = "Bit 24 - DIV clock enable"]
    #[inline(always)]
    pub fn hdiven(&mut self) -> HDIVEN_W<24> {
        HDIVEN_W::new(self)
    }
    #[doc = "Bit 25 - CORDIC clock enable"]
    #[inline(always)]
    pub fn cordicen(&mut self) -> CORDICEN_W<25> {
        CORDICEN_W::new(self)
    }
