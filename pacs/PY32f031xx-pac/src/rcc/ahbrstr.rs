...
#[doc = "Field `HDIVRST` reader - DIV reset"]
pub type HDIVRST_R = crate::BitReader<bool>;
#[doc = "Field `HDIVRST` writer - DIV reset"]
pub type HDIVRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBRSTR_SPEC, bool, O>;
#[doc = "Field `CORDICRST` reader - CORDIC reset"]
pub type CORDICRST_R = crate::BitReader<bool>;
#[doc = "Field `CORDICRST` writer - CORDIC reset"]
pub type CORDICRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBRSTR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - DMA reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 24 - DIV reset"]
    #[inline(always)]
    pub fn hdivrst(&self) -> HDIVRST_R {
        HDIVRST_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - CORDIC reset"]
    #[inline(always)]
    pub fn cordicrst(&self) -> CORDICRST_R {
        CORDICRST_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA reset"]
    ...
    #[doc = "Bit 24 - DIV reset"]
    #[inline(always)]
    pub fn hdivrst(&mut self) -> HDIVRST_W<24> {
        HDIVRST_W::new(self)
    }
    #[doc = "Bit 25 - CORDIC reset"]
    #[inline(always)]
    pub fn cordicrst(&mut self) -> CORDICRST_W<25> {
