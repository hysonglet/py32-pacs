...
pub type EXTI5_W<'a, const O: u8> = crate::BitWriter<'a, u32, EXTICR2_SPEC, bool, O>;
...
pub type EXTI6_W<'a, const O: u8> = crate::BitWriter<'a, u32, EXTICR2_SPEC, bool, O>;
...
pub type EXTI7_W<'a, const O: u8> = crate::BitWriter<'a, u32, EXTICR2_SPEC, bool, O>;
impl R {
    ...
    pub fn exti5(&self) -> EXTI5_R {
        EXTI5_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 16 - GPIO port selection"]
    #[inline(always)]
    pub fn exti6(&self) -> EXTI6_R {
        EXTI6_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 24 - GPIO port selection"]
    #[inline(always)]
    pub fn exti7(&self) -> EXTI7_R {
        EXTI7_R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - GPIO port selection"]
