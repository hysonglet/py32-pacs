...
pub type SMERTPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMERTPE_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:17 - FLash SMERTPE register"]
    #[inline(always)]
    pub fn smertpe(&self) -> SMERTPE_R {
        SMERTPE_R::new((self.bits & 0x0003_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:17 - FLash SMERTPE register"]
...
#[doc = "`reset()` method sets SMERTPE to value 0x0001_4820"]
