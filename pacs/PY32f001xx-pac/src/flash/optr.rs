...
#[doc = "Field `SWD_MODE` reader - SWD_MODE"]
pub type SWD_MODE_R = crate::BitReader<bool>;
#[doc = "Field `SWD_MODE` writer - SWD_MODE"]
pub type SWD_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPTR_SPEC, bool, O>;
...
impl R {
    ...
    pub fn swd_mode(&self) -> SWD_MODE_R {
        SWD_MODE_R::new(((self.bits >> 13) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 13 - SWD_MODE"]
    #[inline(always)]
    pub fn swd_mode(&mut self) -> SWD_MODE_W<13> {
        SWD_MODE_W::new(self)
    }
    #[doc = "Bit 14 - NRST_MODE"]
    #[inline(always)]
