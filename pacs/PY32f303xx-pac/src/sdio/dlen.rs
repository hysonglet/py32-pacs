...
#[doc = "Field `DATALENGTH` reader - desc DATALENGTH"]
pub type DATALENGTH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATALENGTH` writer - desc DATALENGTH"]
pub type DATALENGTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DLEN_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - desc DATALENGTH"]
    #[inline(always)]
    pub fn datalength(&self) -> DATALENGTH_R {
        DATALENGTH_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - desc DATALENGTH"]
