...
#[doc = "Field `WRP` reader - desc WRP"]
pub type WRP_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WRP` writer - desc WRP"]
pub type WRP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRPR_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 0:11 - desc WRP"]
    #[inline(always)]
    pub fn wrp(&self) -> WRP_R {
        WRP_R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - desc WRP"]
