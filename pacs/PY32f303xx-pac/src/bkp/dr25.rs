...
pub struct R(crate::R<DR25_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DR25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DR25_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DR25_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DR25` writer"]
pub struct W(crate::W<DR25_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DR25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DR25_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DR25_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type D_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DR25_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "desc DR25\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dr25](index.html) module"]
