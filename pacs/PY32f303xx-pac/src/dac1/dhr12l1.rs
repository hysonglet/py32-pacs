...
#[doc = "Field `DACC1DHR` reader - desc DACC1DHR"]
pub type DACC1DHR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DACC1DHR` writer - desc DACC1DHR"]
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR12L1_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 3:14 - desc DACC1DHR"]
    #[inline(always)]
    pub fn dacc1dhr(&self) -> DACC1DHR_R {
        DACC1DHR_R::new(((self.bits >> 3) & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 3:14 - desc DACC1DHR"]
    #[inline(always)]
    pub fn dacc1dhr(&mut self) -> DACC1DHR_W<3> {
        DACC1DHR_W::new(self)
    }
