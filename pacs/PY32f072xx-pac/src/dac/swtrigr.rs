...
pub struct R(crate::R<SWTRIGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SWTRIGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SWTRIGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SWTRIGR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl R {
    ...
    pub fn swtrig1(&self) -> SWTRIG1_R {
        SWTRIG1_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - desc SWTRIG2"]
    #[inline(always)]
    pub fn swtrig2(&self) -> SWTRIG2_R {
        SWTRIG2_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - desc SWTRIG1"]
...
impl crate::Readable for SWTRIGR_SPEC {
    type Reader = R;
}
