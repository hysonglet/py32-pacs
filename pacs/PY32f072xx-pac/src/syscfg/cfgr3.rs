...
pub type DMA1_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR3_SPEC, u8, u8, 6, O>;
...
pub type DMA2_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR3_SPEC, u8, u8, 6, O>;
...
pub type DMA3_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR3_SPEC, u8, u8, 6, O>;
...
pub type DMA4_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR3_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5 - desc DMA1_MAP"]
    #[inline(always)]
    pub fn dma1_map(&self) -> DMA1_MAP_R {
        DMA1_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 8:13 - desc DMA2_MAP"]
    #[inline(always)]
    pub fn dma2_map(&self) -> DMA2_MAP_R {
        DMA2_MAP_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - desc DMA3_MAP"]
    #[inline(always)]
    pub fn dma3_map(&self) -> DMA3_MAP_R {
        DMA3_MAP_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29 - desc DMA4_MAP"]
    #[inline(always)]
    pub fn dma4_map(&self) -> DMA4_MAP_R {
        DMA4_MAP_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - desc DMA1_MAP"]
