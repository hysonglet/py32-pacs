...
#[doc = "Field `FLTEN3` reader - Filter enable bit"]
pub type FLTEN3_R = crate::BitReader<bool>;
#[doc = "Field `FLTEN3` writer - Filter enable bit"]
pub type FLTEN3_W<'a, const O: u8> = crate::BitWriter<'a, u32, FR_SPEC, bool, O>;
#[doc = "Field `FLTCNT3` reader - Comparator filter and counter"]
pub type FLTCNT3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FLTCNT3` writer - Comparator filter and counter"]
pub type FLTCNT3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bit 0 - Filter enable bit"]
    #[inline(always)]
    pub fn flten3(&self) -> FLTEN3_R {
        FLTEN3_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 16:31 - Comparator filter and counter"]
    #[inline(always)]
    pub fn fltcnt3(&self) -> FLTCNT3_R {
        FLTCNT3_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bit 0 - Filter enable bit"]
    #[inline(always)]
    pub fn flten3(&mut self) -> FLTEN3_W<0> {
        FLTEN3_W::new(self)
    }
    #[doc = "Bits 16:31 - Comparator filter and counter"]
    #[inline(always)]
    pub fn fltcnt3(&mut self) -> FLTCNT3_W<16> {
        FLTCNT3_W::new(self)
    }
