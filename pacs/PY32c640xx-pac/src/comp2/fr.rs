...
#[doc = "Field `FLTEN2` reader - Filter enable bit"]
pub type FLTEN2_R = crate::BitReader<bool>;
#[doc = "Field `FLTEN2` writer - Filter enable bit"]
pub type FLTEN2_W<'a, const O: u8> = crate::BitWriter<'a, u32, FR_SPEC, bool, O>;
#[doc = "Field `FLTCNT2` reader - Comparator filter and counter"]
pub type FLTCNT2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FLTCNT2` writer - Comparator filter and counter"]
pub type FLTCNT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bit 0 - Filter enable bit"]
    #[inline(always)]
    pub fn flten2(&self) -> FLTEN2_R {
        FLTEN2_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 16:31 - Comparator filter and counter"]
    #[inline(always)]
    pub fn fltcnt2(&self) -> FLTCNT2_R {
        FLTCNT2_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bit 0 - Filter enable bit"]
    #[inline(always)]
    pub fn flten2(&mut self) -> FLTEN2_W<0> {
        FLTEN2_W::new(self)
    }
    #[doc = "Bits 16:31 - Comparator filter and counter"]
    #[inline(always)]
    pub fn fltcnt2(&mut self) -> FLTCNT2_W<16> {
        FLTCNT2_W::new(self)
    }
