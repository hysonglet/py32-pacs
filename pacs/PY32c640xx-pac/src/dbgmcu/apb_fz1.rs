...
#[doc = "Field `DBG_I2C1_TIMEOUT` reader - Debug I2C1 TIMEOUT stopped when Core ishalted"]
pub type DBG_I2C1_TIMEOUT_R = crate::BitReader<bool>;
#[doc = "Field `DBG_I2C1_TIMEOUT` writer - Debug I2C1 TIMEOUT stopped when Core ishalted"]
pub type DBG_I2C1_TIMEOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB_FZ1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 21 - Debug I2C1 TIMEOUT stopped when Core ishalted"]
    #[inline(always)]
    pub fn dbg_i2c1_timeout(&self) -> DBG_I2C1_TIMEOUT_R {
        DBG_I2C1_TIMEOUT_R::new(((self.bits >> 21) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 21 - Debug I2C1 TIMEOUT stopped when Core ishalted"]
    #[inline(always)]
    pub fn dbg_i2c1_timeout(&mut self) -> DBG_I2C1_TIMEOUT_W<21> {
        DBG_I2C1_TIMEOUT_W::new(self)
    }
    #[doc = "Bit 31 - Debug LPTIM stopped when Core ishalted"]
    #[inline(always)]
