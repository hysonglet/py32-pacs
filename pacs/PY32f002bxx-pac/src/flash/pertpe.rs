...
pub type PERTPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PERTPE_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:17 - FLash PERTPE register"]
    #[inline(always)]
    pub fn pertpe(&self) -> PERTPE_R {
        PERTPE_R::new((self.bits & 0x0003_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:17 - FLash PERTPE register"]
...
#[doc = "`reset()` method sets PERTPE to value 0x0001_4820"]
