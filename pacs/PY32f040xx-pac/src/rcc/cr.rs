...
#[doc = "Field `ADC_DIV` reader - ADC Frequency Division"]
pub type ADC_DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADC_DIV` writer - ADC Frequency Division"]
pub type ADC_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 21:22 - ADC Frequency Division"]
    #[inline(always)]
    pub fn adc_div(&self) -> ADC_DIV_R {
        ADC_DIV_R::new(((self.bits >> 21) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 21:22 - ADC Frequency Division"]
    #[inline(always)]
    pub fn adc_div(&mut self) -> ADC_DIV_W<21> {
        ADC_DIV_W::new(self)
    }
    #[doc = "Bit 24 - PLL enable"]
    #[inline(always)]
