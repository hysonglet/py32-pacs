...
#[doc = "Field `PRL` writer - desc PRL"]
pub type PRL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRLL_SPEC, u16, u16, 16, O>;
impl W {
    #[doc = "Bits 0:15 - desc PRL"]
    #[inline(always)]
    pub fn prl(&mut self) -> PRL_W<0> {
        PRL_W::new(self)
    }
