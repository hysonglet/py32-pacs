...
#[doc = "Field `TS1` reader - desc TS1"]
pub type TS1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TS1` writer - desc TS1"]
pub type TS1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TS1_SPEC, u16, u16, 9, O>;
impl R {
    #[doc = "Bits 0:8 - desc TS1"]
    #[inline(always)]
