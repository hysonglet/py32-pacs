...
#[doc = "Field `PR20` reader - configurable event inputs x rising edge Pending bit."]
pub type PR20_R = crate::BitReader<bool>;
#[doc = "Field `PR20` writer - configurable event inputs x rising edge Pending bit."]
...
impl R {
    ...
    #[doc = "Bit 20 - configurable event inputs x rising edge Pending bit."]
    #[inline(always)]
