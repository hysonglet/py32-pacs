...
#[doc = "Field `TS2P` reader - desc TS2P"]
pub type TS2P_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TS2P` writer - desc TS2P"]
pub type TS2P_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TS2P_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - desc TS2P"]
    #[inline(always)]
