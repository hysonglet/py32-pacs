...
#[doc = "Field `DIV_SIGN` reader - des DIV_SIGN"]
pub type DIV_SIGN_R = crate::BitReader<bool>;
#[doc = "Field `DIV_SIGN` writer - des DIV_SIGN"]
pub type DIV_SIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIGN_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - des DIV_SIGN"]
    #[inline(always)]
    pub fn div_sign(&self) -> DIV_SIGN_R {
        DIV_SIGN_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - des DIV_SIGN"]
    #[inline(always)]
    pub fn div_sign(&mut self) -> DIV_SIGN_W<0> {
        DIV_SIGN_W::new(self)
    }
