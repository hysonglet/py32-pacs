...
#[doc = "Field `NRST_FLTDIS` reader - NRST_FLTDIS oscillator ready"]
pub type NRST_FLTDIS_R = crate::BitReader<bool>;
#[doc = "Field `NRST_FLTDIS` writer - NRST_FLTDIS oscillator ready"]
pub type NRST_FLTDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 8 - NRST_FLTDIS oscillator ready"]
    #[inline(always)]
    pub fn nrst_fltdis(&self) -> NRST_FLTDIS_R {
        NRST_FLTDIS_R::new(((self.bits >> 8) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 8 - NRST_FLTDIS oscillator ready"]
    #[inline(always)]
    pub fn nrst_fltdis(&mut self) -> NRST_FLTDIS_W<8> {
        NRST_FLTDIS_W::new(self)
    }
    #[doc = "Bit 23 - Remove reset flags"]
    #[inline(always)]
