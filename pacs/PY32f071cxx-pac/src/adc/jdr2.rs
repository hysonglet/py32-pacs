...
#[doc = "Field `JDR2` reader - desc JDR2"]
pub type JDR2_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - desc JDR2"]
    #[inline(always)]
    pub fn jdr2(&self) -> JDR2_R {
        JDR2_R::new((self.bits & 0xffff) as u16)
    }
}
