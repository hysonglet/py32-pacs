...
#[doc = "Field `JDR3` reader - desc JDR3"]
pub type JDR3_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - desc JDR3"]
    #[inline(always)]
    pub fn jdr3(&self) -> JDR3_R {
        JDR3_R::new((self.bits & 0xffff) as u16)
    }
}
