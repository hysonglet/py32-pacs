...
pub type DBGRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, APBRSTR2_SPEC, bool, O>;
...
#[doc = "Field `COMP3RST` reader - COMP3 reset"]
pub type COMP3RST_R = crate::BitReader<bool>;
#[doc = "Field `COMP3RST` writer - COMP3 reset"]
pub type COMP3RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, APBRSTR2_SPEC, bool, O>;
#[doc = "Field `LCDRST` reader - LCD reset"]
pub type LCDRST_R = crate::BitReader<bool>;
#[doc = "Field `LCDRST` writer - LCD reset"]
pub type LCDRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, APBRSTR2_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 10 - DBG reset"]
    #[inline(always)]
    pub fn dbgrst(&self) -> DBGRST_R {
        DBGRST_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[doc = "Bit 20 - COMP1 reset"]
    #[inline(always)]
    pub fn comp1rst(&self) -> COMP1RST_R {
        COMP1RST_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - COMP2 reset"]
    #[inline(always)]
    pub fn comp2rst(&self) -> COMP2RST_R {
        COMP2RST_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - COMP3 reset"]
    #[inline(always)]
    pub fn comp3rst(&self) -> COMP3RST_R {
        COMP3RST_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - LCD reset"]
    #[inline(always)]
    pub fn lcdrst(&self) -> LCDRST_R {
        LCDRST_R::new(((self.bits >> 23) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - SYSCFG reset"]
    ...
    #[doc = "Bit 10 - DBG reset"]
    #[inline(always)]
    pub fn dbgrst(&mut self) -> DBGRST_W<10> {
        DBGRST_W::new(self)
    }
    #[doc = "Bit 11 - TIM1 reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - COMP1 reset"]
    #[inline(always)]
    pub fn comp1rst(&mut self) -> COMP1RST_W<20> {
        COMP1RST_W::new(self)
    }
    #[doc = "Bit 21 - COMP2 reset"]
    #[inline(always)]
    pub fn comp2rst(&mut self) -> COMP2RST_W<21> {
        COMP2RST_W::new(self)
    }
    #[doc = "Bit 22 - COMP3 reset"]
    #[inline(always)]
    pub fn comp3rst(&mut self) -> COMP3RST_W<22> {
        COMP3RST_W::new(self)
    }
    #[doc = "Bit 23 - LCD reset"]
    #[inline(always)]
    pub fn lcdrst(&mut self) -> LCDRST_W<23> {
        LCDRST_W::new(self)
    }
