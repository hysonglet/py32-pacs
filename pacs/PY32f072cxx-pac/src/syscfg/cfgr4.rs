...
pub type DMA5_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR4_SPEC, u8, u8, 6, O>;
...
pub type DMA6_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR4_SPEC, u8, u8, 6, O>;
...
pub type DMA7_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR4_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5 - desc DMA5_MAP"]
    #[inline(always)]
    pub fn dma5_map(&self) -> DMA5_MAP_R {
        DMA5_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 8:13 - desc DMA6_MAP"]
    #[inline(always)]
    pub fn dma6_map(&self) -> DMA6_MAP_R {
        DMA6_MAP_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - desc DMA7_MAP"]
    #[inline(always)]
    pub fn dma7_map(&self) -> DMA7_MAP_R {
        DMA7_MAP_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - desc DMA5_MAP"]
