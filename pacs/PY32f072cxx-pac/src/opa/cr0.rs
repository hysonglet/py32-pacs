...
#[doc = "Field `OP3OEN1` reader - OP3OEN1"]
pub type OP3OEN1_R = crate::BitReader<bool>;
#[doc = "Field `OP3OEN1` writer - OP3OEN1"]
pub type OP3OEN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 1 - OP1OEN1"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - OP3OEN1"]
    #[inline(always)]
    pub fn op3oen1(&self) -> OP3OEN1_R {
        OP3OEN1_R::new(((self.bits >> 11) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - OP1OEN1"]
    ...
    #[doc = "Bit 11 - OP3OEN1"]
    #[inline(always)]
    pub fn op3oen1(&mut self) -> OP3OEN1_W<11> {
        OP3OEN1_W::new(self)
    }
