...
#[doc = "Field `PRETPE` reader - desc PRETPE"]
pub type PRETPE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PRETPE` writer - desc PRETPE"]
pub type PRETPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRETPE_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 0:13 - desc PRETPE"]
    #[inline(always)]
    pub fn pretpe(&self) -> PRETPE_R {
        PRETPE_R::new((self.bits & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:13 - desc PRETPE"]
