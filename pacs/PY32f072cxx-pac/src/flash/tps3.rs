...
#[doc = "Field `TPS3` reader - desc TPS3"]
pub type TPS3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TPS3` writer - desc TPS3"]
pub type TPS3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TPS3_SPEC, u16, u16, 11, O>;
impl R {
    #[doc = "Bits 0:10 - desc TPS3"]
    #[inline(always)]
