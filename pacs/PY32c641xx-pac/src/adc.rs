...
pub struct RegisterBlock {
    ...
    pub calrr2: CALRR2,
    #[doc = "0x50 - ADC calibration result register 3"]
    pub calrr3: CALRR3,
    #[doc = "0x54 - ADC calibration factor input register 1"]
    pub calfir1: CALFIR1,
    #[doc = "0x58 - ADC calibration factor input register 2"]
    pub calfir2: CALFIR2,
    #[doc = "0x5c - ADC calibration factor input register 2"]
    pub calfir3: CALFIR3,
    _reserved16: [u8; 0x02a8],
...
pub mod calrr2;
#[doc = "CALRR3 (r) register accessor: an alias for `Reg<CALRR3_SPEC>`"]
pub type CALRR3 = crate::Reg<calrr3::CALRR3_SPEC>;
...
pub mod calfir2;
#[doc = "CALFIR3 (rw) register accessor: an alias for `Reg<CALFIR3_SPEC>`"]
pub type CALFIR3 = crate::Reg<calfir3::CALFIR3_SPEC>;
#[doc = "ADC calibration factor input register 2"]
pub mod calfir3;
