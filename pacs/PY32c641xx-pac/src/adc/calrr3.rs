#[doc = "Register `CALRR3` reader"]
pub struct R(crate::R<CALRR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CALRR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CALRR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CALRR3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ADC calibration result register 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [calrr3](index.html) module"]
pub struct CALRR3_SPEC;
impl crate::RegisterSpec for CALRR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [calrr3::R](R) reader structure"]
impl crate::Readable for CALRR3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CALRR3 to value 0"]
impl crate::Resettable for CALRR3_SPEC {
    #[inline(always)]
