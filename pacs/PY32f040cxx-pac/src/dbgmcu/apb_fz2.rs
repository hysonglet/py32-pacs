...
#[doc = "Field `DBG_TIMER15_STOP` reader - Debug Timer 15 stopped when Core is halted"]
pub type DBG_TIMER15_STOP_R = crate::BitReader<bool>;
#[doc = "Field `DBG_TIMER15_STOP` writer - Debug Timer 15 stopped when Core is halted"]
pub type DBG_TIMER15_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB_FZ2_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn dbg_timer15_stop(&self) -> DBG_TIMER15_STOP_R {
        DBG_TIMER15_STOP_R::new(((self.bits >> 16) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 16 - Debug Timer 15 stopped when Core is halted"]
    #[inline(always)]
    pub fn dbg_timer15_stop(&mut self) -> DBG_TIMER15_STOP_W<16> {
        DBG_TIMER15_STOP_W::new(self)
    }
    #[doc = "Bit 17 - Debug Timer 16 stopped when Core is halted"]
    #[inline(always)]
