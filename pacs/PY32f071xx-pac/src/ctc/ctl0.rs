...
pub type TRIMVALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTL0_SPEC, u8, u8, 7, O>;
impl R {
    ...
    #[doc = "Bits 8:14 - desc TRIMVALUE"]
    #[inline(always)]
    pub fn trimvalue(&self) -> TRIMVALUE_R {
        TRIMVALUE_R::new(((self.bits >> 8) & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - desc CKOKIE"]
...
#[doc = "`reset()` method sets CTL0 to value 0x4000"]
