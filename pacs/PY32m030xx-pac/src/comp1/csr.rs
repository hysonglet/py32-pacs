...
pub type SCALER_EN_R = crate::BitReader<bool>;
#[doc = "Field `SCALER_EN` writer - SCALER enable bit"]
pub type SCALER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 1 - SCALER enable bit"]
    #[inline(always)]
    pub fn scaler_en(&mut self) -> SCALER_EN_W<1> {
