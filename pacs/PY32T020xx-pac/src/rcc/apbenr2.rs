...
pub type UART3EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APBENR2_SPEC, bool, O>;
...
#[doc = "Field `TKEN` reader - TK clock enable"]
pub type TKEN_R = crate::BitReader<bool>;
#[doc = "Field `TKEN` writer - TK clock enable"]
pub type TKEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APBENR2_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 13 - UART3 clock enable"]
    #[inline(always)]
    pub fn uart3en(&self) -> UART3EN_R {
        UART3EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    #[doc = "Bit 25 - TK clock enable"]
    #[inline(always)]
    pub fn tken(&self) -> TKEN_R {
        TKEN_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - SYSCFG, COMP and VREFBUF clock enable"]
    ...
    #[doc = "Bit 13 - UART3 clock enable"]
    #[inline(always)]
    pub fn uart3en(&mut self) -> UART3EN_W<13> {
        UART3EN_W::new(self)
    }
    #[doc = "Bit 15 - TIM14 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - TK clock enable"]
    #[inline(always)]
    pub fn tken(&mut self) -> TKEN_W<25> {
        TKEN_W::new(self)
    }
