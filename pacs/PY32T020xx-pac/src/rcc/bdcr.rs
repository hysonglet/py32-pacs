...
#[doc = "Field `RTC_HSEDIV_SEL` reader - "]
pub type RTC_HSEDIV_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RTC_HSEDIV_SEL` writer - "]
pub type RTC_HSEDIV_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BDCR_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `LSCSEL` reader - "]
pub type LSCSEL_R = crate::BitReader<bool>;
#[doc = "Field `LSCSEL` writer - "]
...
impl R {
    ...
    #[doc = "Bits 10:11"]
    #[inline(always)]
    pub fn rtc_hsediv_sel(&self) -> RTC_HSEDIV_SEL_R {
        RTC_HSEDIV_SEL_R::new(((self.bits >> 10) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 10:11"]
    #[inline(always)]
    pub fn rtc_hsediv_sel(&mut self) -> RTC_HSEDIV_SEL_W<10> {
        RTC_HSEDIV_SEL_W::new(self)
    }
    #[doc = "Bit 15 - RTC clock source enable"]
    #[inline(always)]
