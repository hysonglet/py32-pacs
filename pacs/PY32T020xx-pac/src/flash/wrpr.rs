...
#[doc = "Field `WRP` reader - Write Protection Disable"]
pub type WRP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WRP` writer - Write Protection Disable"]
pub type WRP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRPR_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Write Protection Disable"]
    #[inline(always)]
    pub fn wrp(&self) -> WRP_R {
        WRP_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Write Protection Disable"]
    #[inline(always)]
    pub fn wrp(&mut self) -> WRP_W<0> {
        WRP_W::new(self)
    }
