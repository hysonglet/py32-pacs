...
#[doc = "Field `STOPF` reader - Stop detection (slavemode)"]
...
#[doc = "Field `ARLO` reader - Arbitration lost (mastermode)"]
pub type ARLO_R = crate::BitReader<bool>;
#[doc = "Field `ARLO` writer - Arbitration lost (mastermode)"]
...
impl R {
    ...
    #[doc = "Bit 4 - Stop detection (slavemode)"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Arbitration lost (mastermode)"]
    #[inline(always)]
