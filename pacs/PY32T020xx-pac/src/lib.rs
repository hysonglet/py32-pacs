#![doc = "Peripheral access API for PY32T020XX microcontrollers (generated using svd2rust v0.25.1 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub enum Interrupt {
    ...
    SPI1 = 25,
    #[doc = "29 - UART3 global Interrupt"]
    UART3 = 29,
    #[doc = "30 - UART2 global Interrupt"]
    UART2 = 30,
    #[doc = "31 - UART1 global Interrupt"]
    UART1 = 31,
}
...
impl TK {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const tk::RegisterBlock = 0x4000_3800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const tk::RegisterBlock {
        Self::PTR
    }
}
impl Deref for TK {
    type Target = tk::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for TK {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TK").finish()
    }
}
#[doc = "Touch key"]
pub mod tk;
