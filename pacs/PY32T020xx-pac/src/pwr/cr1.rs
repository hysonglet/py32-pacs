...
pub type LPR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPR` writer - Low-power run"]
pub type LPR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR1_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bit 7 - Disable backup domain write protection"]
    #[inline(always)]
    pub fn dbp(&self) -> DBP_R {
        DBP_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 8:9 - Voltage scaling range selection"]
    #[inline(always)]
    pub fn vos(&self) -> VOS_R {
        VOS_R::new(((self.bits >> 8) & 3) as u8)
    }
    ...
    #[doc = "Bits 14:15 - Low-power run"]
    #[inline(always)]
    pub fn lpr(&self) -> LPR_R {
        LPR_R::new(((self.bits >> 14) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - Disable backup domain write protection"]
    #[inline(always)]
    pub fn dbp(&mut self) -> DBP_W<7> {
        DBP_W::new(self)
    }
    #[doc = "Bits 8:9 - Voltage scaling range selection"]
    #[inline(always)]
    pub fn vos(&mut self) -> VOS_W<8> {
        VOS_W::new(self)
    }
    #[doc = "Bits 10:11 - Time selection wakeup from LP to VR"]
    #[inline(always)]
