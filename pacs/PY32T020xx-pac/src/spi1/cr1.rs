...
#[doc = "Field `DDF` reader - "]
pub type DDF_R = crate::BitReader<bool>;
#[doc = "Field `DDF` writer - "]
pub type DDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, bool, O>;
