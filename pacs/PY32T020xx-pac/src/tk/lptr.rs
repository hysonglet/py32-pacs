...
#[doc = "Field `LPWAIT` reader - "]
pub type LPWAIT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPWAIT` writer - "]
pub type LPWAIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPTR_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn lpwait(&self) -> LPWAIT_R {
        LPWAIT_R::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn lpwait(&mut self) -> LPWAIT_W<0> {
        LPWAIT_W::new(self)
    }
