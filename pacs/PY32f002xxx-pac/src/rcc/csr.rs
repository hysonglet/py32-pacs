...
#[doc = "Field `PINRST_FLTDIS` reader - desc PINRST_FLTDIS"]
pub type PINRST_FLTDIS_R = crate::BitReader<bool>;
#[doc = "Field `PINRST_FLTDIS` writer - desc PINRST_FLTDIS"]
pub type PINRST_FLTDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 8 - desc PINRST_FLTDIS"]
    #[inline(always)]
    pub fn pinrst_fltdis(&mut self) -> PINRST_FLTDIS_W<8> {
        PINRST_FLTDIS_W::new(self)
    }
    #[doc = "Bit 23 - Remove reset flags"]
    #[inline(always)]
