...
#[doc = "Field `SYSCFGEN` reader - SYSCFG and VREFBUF clock enable"]
pub type SYSCFGEN_R = crate::BitReader<bool>;
#[doc = "Field `SYSCFGEN` writer - SYSCFG and VREFBUF clock enable"]
...
impl R {
    #[doc = "Bit 0 - SYSCFG and VREFBUF clock enable"]
    #[inline(always)]
