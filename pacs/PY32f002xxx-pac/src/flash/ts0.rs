...
pub type TS0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TS0` writer - FLash TS0 register"]
pub type TS0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TS0_SPEC, u16, u16, 9, O>;
impl R {
    #[doc = "Bits 0:8 - FLash TS0 register"]
    #[inline(always)]
    pub fn ts0(&self) -> TS0_R {
        TS0_R::new((self.bits & 0x01ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:8 - FLash TS0 register"]
